...
},{"vue":"gzxs9","./App.vue":"4ECQH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gzxs9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-a5ed41";
    script.__file = "/var/www/html/airweb/test-frontend-airweb/src/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "a5ed41-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("a5ed41-hmr", script)) __VUE_HMR_RUNTIME__.reload("a5ed41-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"custom:./App.vue":"fm1Mh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","script:./App.vue":"d4wAK","template:./App.vue":"fj7Yd"}],"fm1Mh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d4wAK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _headerVue = require("./components/Header.vue");
var _headerVueDefault = parcelHelpers.interopDefault(_headerVue);
var _productListVue = require("./components/ProductList.vue");
var _productListVueDefault = parcelHelpers.interopDefault(_productListVue);
var _cartVue = require("./components/Cart.vue");
...
exports.default = {
    ...
    components: {
        ...
        ProductList: (0, _productListVueDefault.default),
        Cart: (0, _cartVueDefault.default)
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Header.vue":"gN9X8","./components/Cart.vue":"A3vRM","./components/ProductList.vue":"eMMcj"}],"gN9X8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-7ac8e2";
    script.__file = "/var/www/html/airweb/test-frontend-airweb/src/components/Header.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "7ac8e2-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("7ac8e2-hmr", script)) __VUE_HMR_RUNTIME__.reload("7ac8e2-hmr", script);
        }, 0);
    });
}
exports.default = script;
...
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-7ac8e2"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<section class="header-nav" data-v-7ac8e2><nav data-v-7ac8e2><div class="navbar" data-v-7ac8e2><div class="container nav-container" data-v-7ac8e2><input class="checkbox" type="checkbox" name="" id="" data-v-7ac8e2><div class="hamburger-lines" data-v-7ac8e2><span class="line line1" data-v-7ac8e2></span><span class="line line2" data-v-7ac8e2></span><span class="line line3" data-v-7ac8e2></span></div><div class="header-logo" data-v-7ac8e2><span data-v-7ac8e2><a href="cart.html" data-v-7ac8e2><i class="fa-solid fa-cart-shopping" data-v-7ac8e2></i></a></span></div><div class="menu-items" data-v-7ac8e2><li data-v-7ac8e2><a href="#" data-v-7ac8e2>Lorem</a></li><li data-v-7ac8e2><a href="#" data-v-7ac8e2>Ipsum</a></li><li data-v-7ac8e2><a href="#" data-v-7ac8e2>Lorem</a></li><li data-v-7ac8e2><a href="#" data-v-7ac8e2>Ipsum</a></li></div></div></div></nav></section>', 1);
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createCommentVNode)("NAV MENU"),
        _hoisted_1
    ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("7ac8e2-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9dWgf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8HmPn":[function() {},{}],"A3vRM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./Cart.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./Cart.vue").render;
    script.__cssModules = require("style:./Cart.vue").default;
    require("custom:./Cart.vue").default(script);
    script.__scopeId = "data-v-34f452";
    script.__file = "/var/www/html/airweb/test-frontend-airweb/src/components/Cart.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "34f452-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("34f452-hmr", script)) __VUE_HMR_RUNTIME__.reload("34f452-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./Cart.vue":"kjPkt","template:./Cart.vue":"fIbtO","style:./Cart.vue":"emj8X","custom:./Cart.vue":"kFRdK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kjPkt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    data () {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fIbtO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-34f452"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<section class="all-cart" data-v-34f452><section class="cart" data-v-34f452><div class="cart-logo" data-v-34f452><span class="cart" data-v-34f452><i class="fa-solid fa-cart-shopping" data-v-34f452></i></span><h2 data-v-34f452> Votre panier </h2></div></section><section class="in-cart" data-v-34f452><div class="article" data-v-34f452><li data-v-34f452>Artcile </li><li data-v-34f452>Artcile </li><li data-v-34f452>Artcile </li></div><div class="article-price" data-v-34f452><li data-v-34f452>25\u20AC</li><li data-v-34f452>25\u20AC</li><li data-v-34f452>25\u20AC</li></div></section><section class="total-container" data-v-34f452><span class="text" data-v-34f452>TOTAL</span><span class="total-price" data-v-34f452>125\u20AC</span></section><section class="payment" data-v-34f452><button class="buy-btn" type="button" data-v-34f452> Acc\xe9der au paiement </button></section></section>', 1);
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createCommentVNode)("CART PAGE"),
        _hoisted_1
    ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("34f452-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"emj8X":[function() {},{}],"kFRdK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eMMcj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("script:./ProductList.vue");
    if (script.__esModule) script = script.default;
    script.render = require("template:./ProductList.vue").render;
    script.__cssModules = require("style:./ProductList.vue").default;
    require("custom:./ProductList.vue").default(script);
    script.__scopeId = "data-v-4d696c";
    script.__file = "/var/www/html/airweb/test-frontend-airweb/src/components/ProductList.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "4d696c-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("4d696c-hmr", script)) __VUE_HMR_RUNTIME__.reload("4d696c-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"script:./ProductList.vue":"3lhU8","template:./ProductList.vue":"3nuQO","custom:./ProductList.vue":"fbXC4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","style:./ProductList.vue":"aCnhD"}],"3lhU8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _productServiceJs = require("../services/productService.js");
var _productServiceJsDefault = parcelHelpers.interopDefault(_productServiceJs);
exports.default = {
    data () {
        return {
            productList: []
    ...
    methods: {
        loadProducts () {
            (0, _productServiceJsDefault.default).getAllProducts().then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../services/productService.js":"lpiZ1"}],"lpiZ1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _apiClientService = require("./apiClientService");
...
exports.default = {
    ...
    getAllProducts () {
        ...
        return (0, _axiosDefault.default).get((0, _apiClientService.baseUrl) + endpoint);
    },
    // récupérer les données d'un produit par son id
    getSingleProduct (id) {
        return (0, _axiosDefault.default).get((0, _apiClientService.baseUrl) + endpoint + "/" + id);
    }
};

},{"axios":"jo6P5","./apiClientService":"9yOX7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"9yOX7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "baseUrl", ()=>baseUrl);
const baseUrl = "http://localhost:3000";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3nuQO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _withScopeId = (n)=>((0, _vue.pushScopeId)("data-v-4d696c"), n = n(), (0, _vue.popScopeId)(), n);
const _hoisted_1 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ (0, _vue.createElementVNode)("section", {
        class: "category-name"
    }, [
        /*#__PURE__*/ (0, _vue.createElementVNode)("h1", null, "Nom cat\xe9gorie")
    ], -1 /* HOISTED */ ));
const _hoisted_2 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<section class="product-list" data-v-4d696c><div class="left-card" data-v-4d696c><div class="product-card" data-v-4d696c><img class="product-picture" src="https://picsum.photos/200/300" data-v-4d696c></div></div><div class="center-card" data-v-4d696c><div class="title" data-v-4d696c><h2 data-v-4d696c>Titre du produit</h2><p data-v-4d696c>Description du produit</p></div></div><div class="rigth-card" data-v-4d696c><span class="product-price" data-v-4d696c><p data-v-4d696c>25\u20AC</p></span><span class="icon-cart-add" data-v-4d696c><i class="fa-solid fa-cart-plus" data-v-4d696c></i></span></div></section><section class="product-list" data-v-4d696c><div class="left-card" data-v-4d696c><div class="product-card" data-v-4d696c><img class="product-picture" src="https://picsum.photos/200/300" data-v-4d696c></div></div><div class="center-card" data-v-4d696c><div class="title" data-v-4d696c><h2 data-v-4d696c>Titre produit</h2><p data-v-4d696c>Description du produit</p></div></div><div class="rigth-card" data-v-4d696c><span class="product-price" data-v-4d696c><p data-v-4d696c>25\u20AC</p></span><span class="icon-cart-add" data-v-4d696c><i class="fa-solid fa-cart-plus" data-v-4d696c></i></span></div></section>', 2);
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("body", null, [
        (0, _vue.createCommentVNode)("TITLE CATEGORY NAME ? "),
        _hoisted_1,
        (0, _vue.createCommentVNode)("CARD PRODUCT"),
        _hoisted_2
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("4d696c-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fbXC4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aCnhD":[function() {},{}],"fj7Yd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_ProductList = (0, _vue.resolveComponent)("ProductList");
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createVNode)(_component_Header),
        (0, _vue.createVNode)(_component_ProductList),
        (0, _vue.createCommentVNode)(" <Cart></Cart> ")
    ], 64 /* STABLE_FRAGMENT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("a5ed41-hmr", render);
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","vue":"gzxs9"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire94c2")
